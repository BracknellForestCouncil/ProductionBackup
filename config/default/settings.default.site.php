...
/**
 * @file
 * Drupal site-specific configuration file (DEFAULT environment).
 */
 ...
 */
if (isset($_ENV['DEPLOY_LOCATION']) &&
  $_ENV['DEPLOY_LOCATION'] == 'internal') {
 ...
 *
 */
$drupal_hash_salt = file_get_contents('/var/www/config/default/salt.txt');
 ...
 */
$conf['reverse_proxy_addresses'] = array('172.17.0.1');
...
$conf['file_private_path'] = '/var/www/files/default/private';
$conf['file_public_path'] = 'sites/default/files/public';
$conf['file_temporary_path'] = '/var/www/files/default/tmp';
$conf['site_default_country'] = 'GB';
$conf['site_mail'] = 'no-reply@bracknell-forest.gov.uk';

/**
 * Variable overrides (geolocation):
 */
$conf['geolocation_googlemaps_api_key'] = 'AIzaSyBg58BK-ib8kTj6ej5dtu3iYTEQKCEEmOE';

/**
 * Variable overrides (google_analytics):
 */
$conf['googleanalytics_account'] = 'UA-0000000-00';
$conf['googleanalytics_cache'] = 0;
$conf['googleanalytics_codesnippet_after'] = '';
$conf['googleanalytics_codesnippet_before'] = '';
$conf['googleanalytics_codesnippet_create'] = array();
$conf['googleanalytics_cross_domains'] = '';
$conf['googleanalytics_custom'] = '0';
$conf['googleanalytics_custom_dimension'] = array();
$conf['googleanalytics_custom_metric'] = array();
$conf['googleanalytics_debug'] = 0;
$conf['googleanalytics_domain_mode'] = '0';
$conf['googleanalytics_pages'] = 'admin
admin/*
batch
node/add*
node/*/*
user/*/*';
$conf['googleanalytics_privacy_donottrack'] = 1;
$conf['googleanalytics_roles'] = array(
    1 => 0,
    2 => 0,
    3 => 0,
  );
$conf['googleanalytics_site_search'] = 0;
$conf['googleanalytics_trackadsense'] = 0;
$conf['googleanalytics_trackdoubleclick'] = 0;
$conf['googleanalytics_tracker_anonymizeip'] = 1;
$conf['googleanalytics_trackfiles'] = 1;
$conf['googleanalytics_trackfiles_extensions'] = '7z|aac|arc|arj|asf|asx|avi|bin|csv|doc(x|m)?|dot(x|m)?|exe|flv|gif|gz|gzip|hqx|jar|jpe?g|js|mp(2|3|4|e?g)|mov(ie)?|msi|msp|pdf|phps|png|ppt(x|m)?|pot(x|m)?|pps(x|m)?|ppam|sld(x|m)?|thmx|qtm?|ra(m|r)?|sea|sit|tar|tgz|torrent|txt|wav|wma|wmv|wpd|xls(x|m|b)?|xlt(x|m)|xlam|xml|z|zip';
$conf['googleanalytics_tracklinkid'] = 1;
$conf['googleanalytics_trackmailto'] = 1;
$conf['googleanalytics_trackmessages'] = array(
    'status' => 'status',
    'warning' => 'warning',
    'error' => 'error',
  );
$conf['googleanalytics_trackoutbound'] = 1;
$conf['googleanalytics_trackurlfragments'] = 1;
$conf['googleanalytics_trackuserid'] = 1;
$conf['googleanalytics_visibility_pages'] = '0';
$conf['googleanalytics_visibility_roles'] = '0';

/**
 * Variable overrides (mailsystem):
 */
$conf['mailsystem_theme'] = 'current';
$conf['mail_system'] = array(
    'default-system' => 'SmtpMailSystem',
  );

/**
 * Variable overrides (pathauto):
 */
 $conf['pathauto_max_component_length'] = '128';
 $conf['pathauto_max_length'] = '255';
...
$conf['smtp_debugging'] = '1';
$conf['smtp_from'] = 'no-reply@bracknell-forest.gov.uk';
$conf['smtp_fromname'] = 'Bracknell Forest Council';
$conf['smtp_host'] = '172.17.0.1';
$conf['smtp_hostbackup'] = '172.17.0.1';
$conf['smtp_on'] = '1';
$conf['smtp_password'] = '';
$conf['smtp_port'] = '1025';
$conf['smtp_previous_mail_system'] = 'SmtpMailSystem';
$conf['smtp_protocol'] = 'standard';
$conf['smtp_queue_fail'] = 1;
$conf['smtp_queue'] = 0;
$conf['smtp_test_address'] = '';
$conf['smtp_username'] = '';


/**
 * Variable overrides (localgov):
 */
 $conf['localgov_import_location'] = '/var/www/data';
