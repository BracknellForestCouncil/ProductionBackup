...
/**
 * @file
 * Drupal site-specific configuration file (PRODUCTION environment).
 */
...
$conf['smtp_hostbackup'] = 'email-smtp.eu-west-1.amazonaws.com';
$conf['smtp_password'] = 'Agq/6OylSLFXKpDKNO8nTCzk6EWF+mTlaZPwKBbPy6q8';
$conf['smtp_port'] = '587';
$conf['smtp_protocol'] = 'tls';
$conf['smtp_username'] = 'AKIAIWUN6WTVABMVIVEQ';
