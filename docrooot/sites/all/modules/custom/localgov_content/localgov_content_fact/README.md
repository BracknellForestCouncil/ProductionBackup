# LocalGov Content: Fact (localgov_content_fact) module
...
## About this module
TODO: Add description for the "LocalGov Content: Fact" module.

### Usage Information
TODO: Add usage information for the "LocalGov Content: Fact" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_content_fact.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_content_fact.info`
- `localgov_content_fact.install`
