# LocalGov Content: EasyRead (localgov_content_easyread) module
...
## About this module
TODO: Add description for the "LocalGov Content: EasyRead" module.

### Usage Information
TODO: Add usage information for the "LocalGov Content: EasyRead" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_content_easyread.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_content_easyread.info`
- `localgov_content_easyread.install`
- `localgov_content_easyread.module`
