# LocalGov Base: Pages (localgov_base_pages) module
...
## About this module
TODO: Add description for the "LocalGov Base: Pages" module.

### Usage Information
TODO: Add usage information for the "LocalGov Base: Pages" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_base_pages.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_base_pages.info`
- `localgov_base_pages.install`
