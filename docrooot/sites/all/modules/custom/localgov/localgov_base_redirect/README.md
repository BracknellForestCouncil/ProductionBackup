# LocalGov Base: Redirect (localgov_base_redirect) module
...
## About this module
TODO: Add description for the "LocalGov Base: Redirect" module.

### Usage Information
TODO: Add usage information for the "LocalGov Base: Redirect" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_base_redirect.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_base_redirect.info`
- `localgov_base_redirect.install`
- `localgov_base_redirect.module`
