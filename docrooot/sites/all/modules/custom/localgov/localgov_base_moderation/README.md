# LocalGov Base: Moderation (localgov_base_moderation) module
...
## About this module
TODO: Add description for the "LocalGov Base: Moderation" module.

### Usage Information
TODO: Add usage information for the "LocalGov Base: Moderation" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_base_moderation.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_base_moderation.info`
- `localgov_base_moderation.install`
