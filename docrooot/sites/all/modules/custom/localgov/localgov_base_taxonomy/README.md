# LocalGov Base: Taxonomy (localgov_base_taxonomy) module
...
## About this module
TODO: Add description for the "LocalGov Base: Taxonomy" module.

### Usage Information
TODO: Add usage information for the "LocalGov Base: Taxonomy" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_base_taxonomy.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_base_taxonomy.info`
- `localgov_base_taxonomy.install`
