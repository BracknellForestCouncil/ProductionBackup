# Bracknell Site: Common (bracknell_site_common) module
...
## About this module
TODO: Add description for the "Bracknell Site: Common" module.

### Usage Information
TODO: Add usage information for the "Bracknell Site: Common" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `bracknell_site_common.module`
- `js/` - JS files
- `scss/` - SCSS files
- `bracknell_site_common.info`
- `bracknell_site_common.install`
- `bracknell_site_common.module`
