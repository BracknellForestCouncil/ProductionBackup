# Bracknell Page: Home (bracknell_page_home) module
...
## About this module
TODO: Add description for the "Bracknell Page: Home" module.

### Usage Information
TODO: Add usage information for the "Bracknell Page: Home" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `bracknell_page_home.module`
- `js/` - JS files
- `scss/` - SCSS files
- `bracknell_page_home.info`
- `bracknell_page_home.install`
