# LocalGov Content: Promo (localgov_content_promo) module
...
## About this module
TODO: Add description for the "LocalGov Content: Promo" module.

### Usage Information
TODO: Add usage information for the "LocalGov Content: Promo" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_content_promo.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_content_promo.info`
- `localgov_content_promo.install`
