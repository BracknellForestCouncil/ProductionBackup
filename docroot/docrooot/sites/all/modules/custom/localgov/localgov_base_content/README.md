# LocalGov Base: Content (localgov_base_content) module
...
## About this module
TODO: Add description for the "LocalGov Base: Content" module.

### Usage Information
TODO: Add usage information for the "LocalGov Base: Content" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_base_content.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_base_content.info`
- `localgov_base_content.install`
