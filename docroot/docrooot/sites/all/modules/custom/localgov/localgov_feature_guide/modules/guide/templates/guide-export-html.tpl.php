...
/**
 * @file
 * Default theme implementation for printed version of guide structure.
 *
 * Available variables:
 ...
 * - $contents: Nodes within the current structure rendered through
 *   guide-node-export-html.tpl.php.
 *
 * @see template_preprocess_guide_export_html()
 *
 * @ingroup themeable
 */
?>
