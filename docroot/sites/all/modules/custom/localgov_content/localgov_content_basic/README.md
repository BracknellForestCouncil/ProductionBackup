# LocalGov Content: Basic (localgov_content_basic) module
...
## About this module
TODO: Add description for the "LocalGov Content: Basic" module.

### Usage Information
TODO: Add usage information for the "LocalGov Content: Basic" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_content_basic.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_content_basic.info`
- `localgov_content_basic.install`
