...
<div id="readspeaker_button1" class="rs_skip rsbtn rs_preserve">
    <a class="rsbtn_play" accesskey="L" title="Listen to this page using ReadSpeaker" 
       href="http://app.eu.readspeaker.com/cgi-bin/rsent?customerid=5766&amp;lang=en_uk&amp;readid=readspeaker_content&amp;url=<?php print $rs_path ?>">
        ...
        <div class="row">
            <div<?php print $content_column_class ?>>
                <div id="readspeaker_content">
                    <h2 class="hidden"><?php print $rs_title; ?></h2>
