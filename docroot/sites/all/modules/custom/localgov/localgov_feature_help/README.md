# LocalGov Feature: Help (localgov_feature_help) module
...
## About this module
TODO: Add description for the "LocalGov Feature: Help" module.

### Usage Information
TODO: Add usage information for the "LocalGov Feature: Help" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_feature_help.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_feature_help.info`
- `localgov_feature_help.install`
- `localgov_feature_help.module`
