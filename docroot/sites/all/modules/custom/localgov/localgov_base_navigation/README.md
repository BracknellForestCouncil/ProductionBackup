# LocalGov Base: Navigation (localgov_base_navigation) module
...
## About this module
TODO: Add description for the "LocalGov Base: Navigation" module.

### Usage Information
TODO: Add usage information for the "LocalGov Base: Navigation" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_base_navigation.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_base_navigation.info`
- `localgov_base_navigation.install`
