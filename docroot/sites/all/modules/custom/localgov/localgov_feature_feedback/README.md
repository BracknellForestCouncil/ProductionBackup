# LocalGov Feature: Feedback (localgov_feature_feedback) module
...
## About this module
TODO: Add description for the "LocalGov Feature: Feedback" module.

### Usage Information
TODO: Add usage information for the "LocalGov Feature: Feedback" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_feature_feedback.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_feature_feedback.info`
- `localgov_feature_feedback.install`
- `localgov_feature_feedback.module`
