# LocalGov Base: Admin (localgov_base_admin) module
...
## About this module
TODO: Add description for the "LocalGov Base: Admin" module.

### Usage Information
TODO: Add usage information for the "LocalGov Base: Admin" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_base_admin.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_base_admin.info`
- `localgov_base_admin.install`
