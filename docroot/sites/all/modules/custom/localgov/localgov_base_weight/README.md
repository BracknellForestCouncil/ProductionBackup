# LocalGov Base: Weight (localgov_base_weight) module
...
## About this module
TODO: Add description for the "LocalGov Base: Weight" module.

### Usage Information
TODO: Add usage information for the "LocalGov Base: Weight" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_base_weight.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_base_weight.info`
- `localgov_base_weight.install`
