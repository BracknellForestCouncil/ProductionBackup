# LocalGov Base: User (localgov_base_user) module
...
## About this module
TODO: Add description for the "LocalGov Base: User" module.

### Usage Information
TODO: Add usage information for the "LocalGov Base: User" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_base_user.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_base_user.info`
- `localgov_base_user.install`
- `localgov_base_user.module`
