# LocalGov Feature: Guide (localgov_feature_guide) module
...
## About this module
TODO: Add description for the "LocalGov Feature: Guide" module.

### Usage Information
TODO: Add usage information for the "LocalGov Feature: Guide" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_feature_guide.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_feature_guide.info`
- `localgov_feature_guide.install`
