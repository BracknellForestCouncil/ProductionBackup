# LocalGov Feature: News (localgov_feature_news) module
...
## About this module
TODO: Add description for the "LocalGov Feature: News" module.

### Usage Information
TODO: Add usage information for the "LocalGov Feature: News" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_feature_news.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_feature_news.info`
- `localgov_feature_news.install`
