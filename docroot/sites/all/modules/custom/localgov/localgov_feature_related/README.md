# LocalGov Feature: Related (localgov_feature_related) module
...
## About this module
TODO: Add description for the "LocalGov Feature: Related" module.

### Usage Information
TODO: Add usage information for the "LocalGov Feature: Related" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_feature_related.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_feature_related.info`
- `localgov_feature_related.install`
