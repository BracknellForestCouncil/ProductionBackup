# LocalGov Base: File (localgov_base_file) module
...
## About this module
TODO: Add description for the "LocalGov Base: File" module.

### Usage Information
TODO: Add usage information for the "LocalGov Base: File" module.

## Files and Directories
- `css/` CSS files (generated from SCSS)
- `images/` - Image files
- `includes/` - PHP files included in `localgov_base_file.module`
- `js/` - JS files
- `scss/` - SCSS files
- `localgov_base_file.info`
- `localgov_base_file.install`
